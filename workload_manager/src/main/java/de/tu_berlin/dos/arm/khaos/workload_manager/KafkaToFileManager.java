...
public class KafkaToFileManager implements Runnable {

    /******************************************************************************
     * STATIC VARIABLES
     ******************************************************************************/

    private static final Logger LOG = Logger.getLogger(KafkaToFileManager.class);
    ...
    public KafkaToFileManager(String brokerList, String topic, int linesToFlush, File output) {
